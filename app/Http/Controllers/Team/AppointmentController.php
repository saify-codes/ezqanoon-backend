...
class AppointmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $query          = Appointment::with(['user:id,name,email,phone,avatar', 'attachments'])->where($this->ownerForeignKey, $this->owner->id);
        ...
        return view('team.appointments.index');
    }

    public function edit(string $id)
    {
        $appointment = Appointment::where('id', $id)->where($this->ownerForeignKey, $this->owner->id)->firstOrFail();
        return view('team.appointments.edit', compact('appointment'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('team.appointments.show', compact('appointment'));
    }
}
