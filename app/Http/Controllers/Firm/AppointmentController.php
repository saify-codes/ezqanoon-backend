...
class AppointmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $query          = Appointment::with(['user:id,name,email,phone,avatar', 'attachments'])->where('firm_id',  Auth::guard('firm')->id());
        ...
        return view('firm.appointments.index');
    }

    public function edit(string $id)
    {
        $appointment = Appointment::where('id', $id)->where('firm_id',  Auth::guard('firm')->id())->firstOrFail();
        return view('firm.appointments.edit', compact('appointment'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('firm.appointments.show', compact('appointment'));
    }
}
