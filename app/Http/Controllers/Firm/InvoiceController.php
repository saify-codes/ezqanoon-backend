...
class InvoiceController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $query              = Invoice::select('*')->selectRaw('(total - paid) as balance')->with('milestone')->where('firm_id',  Auth::guard('firm')->id());
        ...
        return view('firm.invoice.index');
    }
    ...
    {
        return view('firm.invoice.create');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('firm.invoice.show', compact('invoice'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('firm.invoice.edit', compact('invoice'));
    }
    ...
    {
        Invoice::where('firm_id',  Auth::guard('firm')->id())->findOrFail($id)->delete();

        if ($request->ajax()) {
            return $this->successResponse('invoice deleted');
        }

        return redirect()->route('firm.invoice.index')->with('success', 'Invoice deleted successfully.');
    }
}
