...
class HearingModal extends BaseModal{
    constructor(caseId, caseName, hearingId, description, date) {
        ...
        this.date            = date;
        this.url             = `/team/cases/${caseId}/hearing/${hearingId}`;
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    <a href="/team/manage/cases/${this.caseId}" type="submit" class="btn btn-warning me-2">View case</a>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    <a href="/team/manage/appointments/${this.appointmentId}" type="submit" class="btn btn-warning me-2">View appointment</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="mb-3">
                                    <a href="/team/calendar/${this.eventId}" type="submit" class="btn btn-warning me-2">View event</a>
                                </div>
                            </form>
                        </div>
                    </div>
