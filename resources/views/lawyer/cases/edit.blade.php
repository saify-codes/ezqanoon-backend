<!-- resources/views/lawyer/cases/edit.blade.php -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('lawyer.cases.update', $case->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="opposite_party_advocate_details" class="form-label">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="payment_status" name="payment_status">
                            <option value="PENDING"
                                {{ old('payment_status', $case->payment_status) === 'PENDING' ? 'selected' : '' }}>
                                PENDING</option>
                            <option value="PAID"
                                {{ old('payment_status', $case->payment_status) === 'PAID' ? 'selected' : '' }}>PAID
                            </option>
                            <option value="OVERDUE"
                                {{ old('payment_status', $case->payment_status) === 'OVERDUE' ? 'selected' : '' }}>
                                OVERDUE</option>
                        </select>
                    </div>
                </div>
