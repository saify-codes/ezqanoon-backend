<x-lawyer.app>
    ...
    <!-- Action Buttons -->
    <div class="d-flex">
        <a href="{{ route('lawyer.appointment.edit', $appointment->id) }}" class="btn btn-primary btn-icon-text me-3">
            <i data-feather="edit-2"></i> Edit appointment
        </a>
        {{-- <form action="{{ route('lawyer.appointment.destroy', $appointment->id) }}" method="POST"
