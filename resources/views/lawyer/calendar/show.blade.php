<x-lawyer.app>
    ...
    <!-- Action Buttons -->
    <div class="d-flex">
        <a href="{{ route('lawyer.calendar.edit', $calendarEvent->id) }}" class="btn btn-primary btn-icon-text me-3">
            <i data-feather="edit-2"></i> Edit Event
        </a>
        <form action="{{ route('lawyer.calendar.destroy', $calendarEvent->id) }}" method="POST"
