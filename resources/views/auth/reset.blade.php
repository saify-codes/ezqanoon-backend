                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <form class="forms-sample" action="{{ route('reset') }}" method="POST">
                                    @csrf
                                    
                                    <input type="hidden" value="{{request()->token}}" class="form-control" name="token"/>
                                    <input type="hidden" value="{{request()->accountType}}" class="form-control" name="type"/>
                                    ...
                                    <a href="{{ route('signin') }}" class="d-block mt-3 text-muted">
