<x-team.app>
    <div>
        <a href="{{ route('team.cases.index') }}" class="btn btn-dark btn-icon-text mb-3">
    ...
    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h6>Case Details</h6>
            <x-team.payment-badge :status="$case->payment_status" style="font-size: 1rem" />
        </div>
        <div class="card-body">
                ...
                <table class="table table-hover" style="table-layout: fixed">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><x-team.status-badge :status="$case->status" /></td>
                        </tr>
                        <tr>
                            <th scope="row">Urgency</th>
                            <td><x-team.urgency-badge :status="$case->urgency" /></td>
                        </tr>
                        <tr>
                        ...
                        @foreach ($case->attachments as $attachment)
                            ...
                            <div class="attachment" id="attachment-{{ $attachment->id }}">
                                ...
                                <button type="button" class="delete-attachment-button"
                                    data-url="{{ route('team.cases.attachments.destroy', [$case->id, $attachment->id]) }}">
    ...
    <!-- Action Buttons -->
    <div class="d-flex">
        <a href="{{ route('team.cases.edit', $case->id) }}" class="btn btn-primary btn-icon-text me-3">
            <i data-feather="edit-2"></i> Edit Case
        </a>
        <form action="{{ route('team.cases.destroy', $case->id) }}" method="POST"
