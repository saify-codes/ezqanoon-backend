<x-team.app>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Welcome {{ Auth::guard('team')->user()->name }}</h4>
        </div>
    </div>

    @if (Auth::guard('team')->user()->hasPermission('dashboard:stats'))
        <div class="row mb-5">
    ...
    @push('custom-scripts')
        <script src="{{ asset('assets/js/team/inbox.js') }}"></script>
        <script src="{{ asset('assets/js/team/calendar-event-modals.js') }}"></script>
        ...
        <script>
            $(document).ready(function() {
                ...
                const calendar = new FullCalendar.Calendar($('#calendar')[0], {
                    ...
                    events: "{{ route('team.calendar.events') }}",
