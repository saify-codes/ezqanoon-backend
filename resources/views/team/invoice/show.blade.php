<x-team.app>
                ...
                <table class="table table-hover" style="table-layout: fixed">
                    <tbody>
                                ...
                                <table class="table">
                                    ...
                                    @foreach ($invoice->milestone as $milestone)
                                        <tr>
                                            ...
                                            <td><x-team.payment-badge :status="$milestone['status']"/></td>
                                        </tr>
                                    @endforeach
                                </table>
                            </td>
                        @else   
                            <tr>
                                <th scope="row">Status</th>
                                <td><x-team.payment-badge :status="$invoice->status"/></td>
                            </tr>
                            <tr>
                                <th scope="row">Due date</th>
    ...
    <!-- Action Buttons -->
    <div class="d-flex">
        <a href="{{ route('team.invoice.edit', $invoice->id) }}" class="btn btn-primary btn-icon-text me-3">
            <i data-feather="edit-2"></i> Edit invoice
        </a>
        <form action="{{ route('team.invoice.destroy', $invoice->id) }}" method="POST"
