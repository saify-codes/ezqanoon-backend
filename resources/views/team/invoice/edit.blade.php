<x-team.app>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('team.invoice.update', $invoice->id) }}" method="POST" id="invoice-form">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="country" class="form-control" value="{{ old('country', $invoice->country) }}" placeholder="e.g. Pakistan">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">City</label>
                        <input type="text" name="city" class="form-control" value="{{ old('city', $invoice->city) }}" placeholder="e.g. Karachi">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" id="case-type" name="case_type" required>
                            <option value="CRIMINAL" {{ old('case_type', $invoice->case_type) === 'CRIMINAL' ? 'selected' : '' }}>CRIMINAL</option>
                            <option value="CIVIL"    {{ old('case_type', $invoice->case_type) === 'CIVIL' ? 'selected' : '' }}>CIVIL</option>
                            <option value="OTHERS"   {{ !in_array(old('case_type', $invoice->case_type), ['CRIMINAL', 'CIVIL'])? 'selected' : '' }}>OTHERS</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-3 justify-content-end">
                    <div class="col-md-3">
                        ...
                        <input type="number" min="0" name="paid" class="form-control" value="{{ old('paid', $invoice->paid) }}" placeholder="Enter amount paid">
                    </div>
                </div>
                ...
                if (value === 'OTHERS') {
                    parent.prop('class', 'col-md-1').after(`
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" id="otherType" name="case_type" placeholder="Enter case type" value="{{old('case_type', $invoice->case_type)}}"/>
                        </div>
                    `);
                } else {
