<x-firm.app>
    <div>
        <a href="{{ route('firm.appointment.index') }}" class="btn btn-dark btn-icon-text mb-3">
                        ...
                        @foreach ($appointment->attachments as $attachment)
                            ...
                            <div class="attachment" id="attachment-{{ $attachment->id }}">
                                ...
                                {{-- <button type="button" class="delete-attachment-button"
                                    data-url="{{ route('firm.client.attachments.destroy', [$appointment->id, $attachment->id]) }}">
    ...
    <!-- Action Buttons -->
    <div class="d-flex">
        <a href="{{ route('firm.appointment.edit', $appointment->id) }}" class="btn btn-primary btn-icon-text me-3">
            <i data-feather="edit-2"></i> Edit appointment
        </a>
        {{-- <form action="{{ route('firm.appointment.destroy', $appointment->id) }}" method="POST"
