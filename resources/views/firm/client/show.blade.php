<x-firm.app>
    <div>
        <a href="{{ route('firm.client.index') }}" class="btn btn-dark btn-icon-text mb-3">
                        ...
                        @foreach ($client->attachments as $attachment)
                            ...
                            <div class="attachment" id="attachment-{{ $attachment->id }}">
                                ...
                                <button type="button" class="delete-attachment-button"
                                    data-url="{{ route('firm.client.attachments.destroy', [$client->id, $attachment->id]) }}">
    ...
    <!-- Action Buttons -->
    <div class="d-flex">
        <a href="{{ route('firm.client.edit', $client->id) }}" class="btn btn-primary btn-icon-text me-3">
            <i data-feather="edit-2"></i> Edit Client
        </a>
        <form action="{{ route('firm.client.destroy', $client->id) }}" method="POST"
