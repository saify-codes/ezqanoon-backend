<x-firm.app>
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <form action="{{ route('firm.profile') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')

                {{-- === IMAGE / DOCUMENT UPLOADERS ==================================== --}}
                @php
                    $firm = Auth::guard('firm')->user();
                @endphp

                <div class="d-flex gap-2 flex-wrap mb-4">
                    {{-- Avatar --}}
                    <div class="uploader" data-type="avatar" data-label="Avatar"
                        data-url="{{ str_ends_with($firm->avatar, '/assets/images/avatar.jpg') ? '' : $firm->avatar }}">
                    </div>

                    {{-- Selfie --}}
                    <div class="uploader" data-type="selfie" data-label="Selfie" data-url="{{ $firm->selfie ?? '' }}">
                    </div>

                    {{-- Licence – front --}}
                    <div class="uploader" data-type="licence_front" data-label="Front licence"
                        data-url="{{ $firm->licence_front ?? '' }}">
                    </div>

                    {{-- Licence – back --}}
                    <div class="uploader" data-type="licence_back" data-label="Back licence"
                        data-url="{{ $firm->licence_back ?? '' }}">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $firm->email) }}" disabled>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="phone" name="phone"
                        value="{{ old('phone', $firm->phone) }}" disabled>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                        value="{{ old('name', $firm->name) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="licence_number" name="licence_number"
                        value="{{ old('licence_number', $firm->licence_number) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="cnic" name="cnic"
                        value="{{ old('cnic', $firm->cnic) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="city" name="city"
                        value="{{ old('city', $firm->city) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="country" name="country"
                        value="{{ old('country', $firm->country) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="location" name="location"
                        value="{{ old('location', $firm->location) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select type="text" class="form-select" id="specialization" name="specialization[]" multiple required>
                        @foreach (getSpecializationList() as $specialization)
                            <option value="{{$specialization}}" {{in_array($specialization, $firm->specialization ?? []) ? 'selected' : ''}}>{{$specialization}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="qualification" name="qualification"
                        value="{{ old('qualification', $firm->qualification) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" class="form-control" id="experience" name="experience"
                        value="{{ old('experience', $firm->experience) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" min="0" class="form-control" id="price" name="price"
                        value="{{ old('price', $firm->price) }}" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    @php
                        $availabilities = old('availability', $firm->availabilities->groupBy('day')->map(fn($availability) => $availability->pluck('time')));
                        $days           = [
                                            'mon' => 'Monday',
                                            'tue' => 'Tuesday',
                                            'wed' => 'Wednesday',
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" class="form-control" rows="5" name="description" required>{{ old('description', $firm->description) }}</textarea>
                    @error('description')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('firm.reset-password') }}" method="POST">
                @csrf
                @method('PUT')
    ...
    @push('custom-scripts')
        <script>
            ...
            const baseRoute = '{{ route('firm.file.upload', ':type') }}';
