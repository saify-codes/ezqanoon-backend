<x-firm.app>
    <div>
        <a href="{{route('firm.team.create')}}" class="btn btn-primary btn-icon-text mb-3">
            ...
            $('#team-table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'created_at' },
                    {
                        ...
                        data: function(user) {
                            // Build URLs
                            const editUrl   = `{{ route('firm.team.edit', ':id') }}`.replace(':id', user.id);
                            const deleteUrl = `{{ route('firm.team.destroy', ':id') }}`.replace(':id', user.id);
